...
export const MonthlyHeatmap: React.FC<MonthlyHeatmapProps> = ({
  ...
  return (
    <div className="flex items-center justify-start gap-[2px] w-full px-1 py-1.5">
      {days.map((day, idx) => {
        let content = null;
        let className = "flex-grow aspect-square max-w-[8px] max-h-[8px] rounded-[1.5px] flex items-center justify-center text-[7px] font-black underline-offset-1 leading-none transition-all";
